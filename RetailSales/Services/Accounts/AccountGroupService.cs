    ...
    public class AccountGroupService : IAccountGroupService
    {
        ...
        public DataTable GetAllAccountGroupGRID(string strStatus)
        {
            ...
            if (strStatus == "Y" || strStatus == null)
            {
                ...
                //SvSql = "SELECT ACC_GROUP.ID, ACC_GROUP.ACC_CLASS, ACC_TYPE.ACC_TYPE_NAME, ACC_GROUP.ACC_GRP_NAME, ACC_GROUP.IS_ACTIVE FROM ACC_GROUP LEFT OUTER JOIN ACC_TYPE ON ACC_TYPE.ACC_TYPE_NAME=ACC_GROUP.ACC_TYPE WHERE ACC_GROUP.IS_ACTIVE = 'Y' ORDER BY ACC_GROUP.ID DESC";
            ...
            else
            {
                ...
                //SvSql = "SELECT ACC_GROUP.ID, ACC_GROUP.ACC_CLASS, ACC_TYPE.ACC_TYPE_NAME, ACC_GROUP.ACC_GRP_NAME, ACC_GROUP.IS_ACTIVE FROM ACC_GROUP LEFT OUTER JOIN ACC_TYPE ON ACC_TYPE.ACC_TYPE_NAME=ACC_GROUP.ACC_TYPE WHERE ACC_GROUP.IS_ACTIVE = 'N' ORDER BY ACC_GROUP.ID DESC";
